<?php
/**
 * login.php — Halaman Login (sama persis dengan index.php mode login)
 * EvenTech Platform
 */
...
<head>
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .demo-box strong { color: var(--gold-lt); }
...
<body>
  ...
  <div class="left-panel">
    ...
    <div class="left-hero">
      ...
      <h1>Kelola Event IT<br>dengan <em>Presisi.</em></h1>
      <p>EvenTech adalah platform terpadu untuk menemukan dan mengikuti berbagai event teknologi — mulai dari webinar, seminar, workshop, hingga hackathon. Jelajahi event sesuai minat Anda, lakukan pendaftaran dengan mudah, dan kelola seluruh partisipasi dalam satu sistem yang praktis dan terintegrasi.</p>
    </div>
    <div class="features">
  ...
  <div class="right-panel">
    <div class="auth-card">
      ...
      <p class="subtitle">Masuk untuk menjelajahi event IT terbaik.</p>
      ...
      <form method="POST" action="auth.php">
        ...
        <div class="form-group">
          ...
          <div class="input-wrap">
            <span class="icon">🔒</span>
            <input type="password" name="password" id="passField" placeholder="••••••••" required autocomplete="current-password">
            <button type="button" class="pass-toggle" onclick="togglePass()">👁</button>
          </div>
        </div>
        <button type="submit" class="btn-primary">Masuk ke EvenTech →</button>
      </form>

      <div class="divider"></div>
<div class="demo-box" style="text-align: center;">
    <p>Belum punya akun? <a href="register.php" style="color: var(--gold-lt); text-decoration: none;">Daftar di sini →</a></p>
</div>
    </div>
  </div>
